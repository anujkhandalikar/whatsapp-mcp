...
func main() {
	...
	if client.Store.ID == nil {
		// No ID stored — pair with phone number (WA_PHONE env) or QR code fallback
		...
		if phone != "" {
			// Wait for first QR event (required before PairPhone works)
			go func() {
			...
			// Small delay to let the QR channel initialise
